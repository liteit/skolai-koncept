      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">Om EduInnovate</h3>
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="text-sm">Email: info@eduinnovate.se</p>
        ...
        <div className="mt-8 text-center text-sm">
          <p>&copy; 2024 EduInnovate. Alla rättigheter förbehållna.</p>
        </div>
      </div>
    </footer>
  );
